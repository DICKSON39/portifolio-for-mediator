...
import { Mail, Phone, MessageSquare, Scale, Linkedin, Facebook, Send } from 'lucide-react';

const Footer = () => {

  const currentYear = new Date().getFullYear();
  const whatsappUrl =
    "https://wa.me/254724771029?text=Hello%20Albert,%20I%20would%20like%20to%20inquire%20about%20your%20mediation%20services.";
  ...
  const recipient = "albertkagwanja917@gmail.com";
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="bg-white rounded-[3rem] shadow-xl overflow-hidden flex flex-col lg:flex-row mb-20 border border-gray-100">
          ...
          <div className="lg:w-1/2 p-10 md:p-16 bg-red-700 text-white flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-6">
                ...
                <a href="tel:+254724771029" className="flex items-center gap-4 group">
                  ...
                  <div>
                    <p className="text-sm text-red-200 uppercase font-bold tracking-wider">
                      Call / WhatsApp
                    </p>
                ...
                <a
                  href="mailto:albertkagwanja917@gmail.com"
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xl font-semibold underline decoration-red-400">
                      albertkagwanja917@gmail.com
                    </p>
                  </div>
                </a>
            ...
            <div className="mt-12 pt-10 border-t border-red-600/50">
              <button
                ...
                className="bg-green-500 hover:bg-green-600 text-white px-8 py-4 rounded-xl font-bold flex items-center gap-2 transition-all transform hover:scale-105"
              >
          ...
          <div className="lg:w-1/2 p-10 md:p-16 bg-white">
            ...
            <form onSubmit={sendEmail} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full py-4 rounded-xl font-bold flex items-center justify-center gap-2 bg-slate-900 text-white hover:bg-red-700 transition-all"
              >
                <Send size={20} />
                Send Message
              </button>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-gray-200 gap-4 text-slate-500 text-sm">
          ...
          <div className="flex gap-6">
            ...
            <a
              href="https://facebook.com/albert.kagwanja.7"
